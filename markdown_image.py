...
# Some notes on the script version of this 

# I think that what I want to do will involve specifying the destination, but
# _not_ the source (as the location of screenshots is always going to be the
# same, depending on the OS)

# So, what this script needs to do looks like (as a first pass):
# python markdown_image.py ~/Documents/in_silico/stuff

# Note that this method would assume that you want to add things to the 
# image file that was located in this directory. 
